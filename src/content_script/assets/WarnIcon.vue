<template>
  <!-- https://iconscout.com/icons/alert -->
  <div id="alert-icon-hub-wrapper">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="alert-icon-hub">
      <path
